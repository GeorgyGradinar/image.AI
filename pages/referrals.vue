<template>
  <div class="wrapper-referrals">
    <section class="referrals">
      ...
      <p>Получите больше красок, поделившись getimg.ai с друзьями.</p>

      <h3>Дай 100 красок, получи 100 красок.</h3>
      <p>Каждый, кого вы пригласите, получит 100 красок на изображение. Как только они создадут у нас учетную запись,
        вы тоже получите 100 красок. Краски, заработанные через рефералов, не имеют срока действия, и нет ограничений
